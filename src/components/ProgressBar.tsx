...
const VerticalProgress: React.FC<ProgressBarProps> = ({
  ...
  return (
    <aside className="hidden md:flex flex-col items-center pt-4 pr-4 -ml-25 mr-20">
      <div className="relative w-2 h-full justify-center items-center rounded-full bg-slate-800/70 overflow-hidden shadow-[0_0_20px_rgba(15,23,42,0.8)]">
        <div
